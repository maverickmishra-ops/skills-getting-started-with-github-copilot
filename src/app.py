...
activities = {
    ...
    "Basketball Team": {
        "description": "Train for the school basketball team and compete in games",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Practice swim techniques and prepare for swim meets",
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["lily@mergington.edu", "isaac@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse plays and develop acting skills for performances",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions across biology, chemistry, and physics",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
